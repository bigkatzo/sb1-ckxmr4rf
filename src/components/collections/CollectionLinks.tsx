      ...
      if (collection.pumpfun_url) {
        linksContent += `
          <a
            ...
            aria-label="PumpFun"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 512 512" fill="currentColor" stroke="none">
              <path d="M469.127,42.874C441.479,15.226,404.72,0,365.62,0c-39.1,0-75.859,15.226-103.506,42.873L152.5,152.489c-0.002,0.002-0.003,0.003-0.005,0.005L42.873,262.114C15.226,289.762,0,326.521,0,365.62s15.226,75.858,42.873,103.506C70.521,496.774,107.28,512,146.38,512s75.859-15.226,103.506-42.873L359.5,359.511c0.002-0.002,0.003-0.003,0.005-0.005l109.62-109.62C496.774,222.238,512,185.479,512,146.38C512,107.28,496.774,70.521,469.127,42.874z M235.461,454.702c-23.794,23.795-55.431,36.9-89.081,36.9c-33.65,0-65.288-13.105-89.082-36.9c-23.795-23.794-36.9-55.431-36.9-89.082c0-33.651,13.105-65.287,36.9-89.082L159.706,174.13L337.87,352.294L235.461,454.702z M454.702,235.461L352.294,337.87L174.13,159.706L276.539,57.298c23.794-23.795,55.431-36.9,89.081-36.9c33.65,0,65.288,13.105,89.082,36.9c23.795,23.794,36.9,55.431,36.9,89.082C491.602,180.03,478.497,211.667,454.702,235.461z"/>
            </svg>
          </a>
        `;
      }
