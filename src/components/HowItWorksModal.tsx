...
export function HowItWorksModal() {
  ...
  return (
    ...
    >
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[98]" onClick={closeHowItWorks} />

      <div className="fixed inset-0 flex items-center justify-center p-4 z-[99]">
