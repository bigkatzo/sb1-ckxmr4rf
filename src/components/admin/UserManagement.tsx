    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => fetchUsers()}
            className="inline-flex items-center gap-1.5 bg-gray-700 hover:bg-gray-600 text-white px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg transition-colors text-xs sm:text-sm"
            disabled={loading}
          >
            <svg
