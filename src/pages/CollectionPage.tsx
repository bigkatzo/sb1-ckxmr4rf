          ...
          <div className="relative aspect-[21/9] overflow-hidden rounded-xl sm:rounded-2xl">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent">
              ...
              <div className="absolute top-0 right-0 p-4 sm:p-6 flex gap-2">
                {isUpcoming && (
                  <div className="flex items-center gap-2 bg-blue-500/90 backdrop-blur-sm text-white px-2.5 py-1 sm:px-4 sm:py-2 md:px-5 md:py-2.5 rounded-xl sm:rounded-2xl">
                    <Clock className="h-3.5 w-3.5 sm:h-5 sm:w-5" />
                    <span className="text-xs sm:text-base font-medium whitespace-nowrap">
                      <CountdownTimer targetDate={collection.launchDate} />
                    </span>
                  </div>
                )}
