...
DO $$ BEGIN
  DROP POLICY IF EXISTS "merchant_dashboard_products" ON products;
  DROP POLICY IF EXISTS "merchant_dashboard_categories" ON categories;
  DROP POLICY IF EXISTS "merchant_dashboard_orders" ON orders;
