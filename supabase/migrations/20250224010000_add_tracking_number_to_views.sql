...
-- Recreate user orders view with tracking_number
...
-- Recreate merchant orders view with tracking_number
...
COMMENT ON VIEW user_orders IS 'View of orders for authenticated users, including tracking information';
