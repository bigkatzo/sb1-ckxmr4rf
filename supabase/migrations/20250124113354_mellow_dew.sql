...
BEGIN
  ...
  IF (
    ...
    -- Supabase storage URLs (including project-specific)
    url ~* '^https?://sakysysfksculqobozxi\.supabase\.co/storage/v1/object/public/' OR
...
-- Create function to sanitize image URL
