...
CREATE TABLE transaction_logs (
  ...
  status text NOT NULL CHECK (status IN ('pending', 'confirmed', 'failed', 'order_created', 'order_failed')),
...
CREATE INDEX idx_transaction_logs_buyer ON transaction_logs(buyer_address);
