-- Check if collection_access table exists
DO $$ BEGIN
...
DROP FUNCTION IF EXISTS revoke_collection_access(uuid, uuid);
DROP FUNCTION IF EXISTS get_user_collection_access(uuid);
