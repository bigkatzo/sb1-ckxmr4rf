...
-- Create super simple admin check function that doesn't rely on user_profiles
CREATE OR REPLACE FUNCTION auth.is_admin()
RETURNS boolean AS $$
BEGIN
  -- Direct email check without any table lookups
...
-- Create function to get merchant dashboard data without any access checks
...
BEGIN
  -- Return all data regardless of user
  RETURN QUERY
  SELECT
