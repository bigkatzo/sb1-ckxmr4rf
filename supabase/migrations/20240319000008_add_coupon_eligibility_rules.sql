...
-- Add eligibility_rules column to coupons table
ALTER TABLE coupons
ADD COLUMN IF NOT EXISTS eligibility_rules JSONB DEFAULT '{"groups": []}'::jsonb;

-- Drop existing function
DROP FUNCTION IF EXISTS apply_coupon_to_order(UUID, TEXT);

-- Update apply_coupon_to_order function to check eligibility
