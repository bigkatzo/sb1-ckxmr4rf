...
BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      -- CRITICAL: Never let notification failures block category creation
...
BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      -- CRITICAL: Never let notification failures block product creation
...
BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      -- CRITICAL: Never let notification failures block access management
...
BEGIN
  ...
  BEGIN
    ...
    LOOP
      ...
      EXCEPTION
        WHEN OTHERS THEN
          -- Log error but continue processing other admins
  ...
  EXCEPTION
    WHEN OTHERS THEN
      -- CRITICAL: Never let notification failures block user registration
...
BEGIN
  ...
  EXCEPTION
    WHEN OTHERS THEN
      -- CRITICAL: Never let notification failures block collection creation
