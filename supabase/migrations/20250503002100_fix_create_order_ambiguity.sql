...
-- Drop all versions of create_order function
DROP FUNCTION IF EXISTS create_order(UUID, JSONB, JSONB, TEXT);
DROP FUNCTION IF EXISTS create_order(UUID, JSONB, JSONB, TEXT, JSONB);

-- Create single version of create_order function with payment_metadata
