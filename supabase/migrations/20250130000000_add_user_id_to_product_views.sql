-- Migration: Add user_id to public product views
-- This allows displaying creator information in product modals
...
-- Recreate public_products view with user_id from collections
...
-- Recreate public_products_with_categories view with user_id from collections
...
-- Recreate best sellers functions to handle the updated views
