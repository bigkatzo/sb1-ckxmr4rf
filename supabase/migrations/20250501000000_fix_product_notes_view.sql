-- Fix for product notes display issue in the public views
...
-- Recreate public_products view with explicit field aliasing for notes fields
...
-- Recreate public_products_with_categories view with explicit field aliasing for notes fields
...
-- Grant permissions again to ensure they're set correctly
