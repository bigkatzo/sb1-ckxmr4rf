-- Simplify access function to collection-level only
BEGIN;
...
DROP FUNCTION IF EXISTS grant_collection_access(uuid, uuid, text, uuid, uuid);

-- Create simplified function for collection-level access only
