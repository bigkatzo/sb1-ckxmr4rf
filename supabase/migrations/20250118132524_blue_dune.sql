...
-- Create function to verify dashboard access
CREATE OR REPLACE FUNCTION verify_dashboard_access()
RETURNS TABLE (
  check_name text,
  status boolean,
  details text
...
-- Run verification
SELECT * FROM verify_dashboard_access();

-- Drop verification function
DROP FUNCTION verify_dashboard_access();