-- Migration to add amount and quantity fields to merchant_orders view
...
-- Recreate merchant orders view with amount and quantity fields
...
COMMENT ON VIEW merchant_orders IS 'View of orders for merchants and admins, including tracking information, amount, and quantity fields';
