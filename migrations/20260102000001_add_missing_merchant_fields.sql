-- Add missing merchant/creator fields to view and functions
-- This adds back the collection_user_id and collection_owner_merchant_tier fields
...
-- Recreate the view with merchant/creator fields included
...
-- Recreate get_best_sellers function
...
-- Recreate get_trending_products function
...
-- Recreate get_products_by_launch_date function
